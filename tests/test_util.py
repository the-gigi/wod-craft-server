...
def create_mem_db(db):
    ...
    The operation is very tricky because it requires replacing and later restoring the engine
    in the guts of Flask-SQLAlchemy.

    The engine is accessible through a get_engine() method that must be replaced and later
    restored.
    ...
    NOTE: You must call db.restore_engine() in the tearDown() method of your test
    """
